...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "v3.10.4"
  WORKING_DIRECTORY "/Users/mitchellverhelle/C++ Class/Emulator/build/_deps/ctre-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v3.10.4")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/mitchellverhelle/C++ Class/Emulator/build/_deps/ctre-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/mitchellverhelle/C++ Class/Emulator/build/_deps/ctre-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
